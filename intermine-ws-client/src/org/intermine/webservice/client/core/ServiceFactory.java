...
/**
 * The Class that should be used for creating services. You should never need to
 * create instances of service classes directly with their constructors - it is
 * simpler to use this factory. This factory deals with constructing services
...
public class ServiceFactory {
	 ...
	 * 
	 * @param rootUrl
	 *            the base URL for all services, it is the prefix common to all
	 *            services. Example: http://www.flymine.org/query/service
	 */
	...
	/**
	 * Construct a factory for gaining access to specific resources. Allows you
	 * to set the root url and the authorization token. Use this constructor if
	 * you need to access private restricted-access resources.
	 * 
	 * @param rootUrl
	 *            the base URL for all services, it is the prefix common to all
	 *            services. Example: http://www.flymine.org/query/service
	 ...
	 *            services. Example: http://www.flymine.org/query/service
	 * @param userName
	 *            your user account name (usually an email address)
	 * @param userPass
	 *            your user account password, in plain text.
	 *
	 *            <em>Please do not use this constructor unless you absolutely have to. Token
	 * identification is preferred</em>
	 * @deprecated This method causes username and password information to be
	 *             insecurely transmitted over HTTP connections. Use the token
	...
	// Variables for caching services. There is never going to be a need to
	// create more
	 ...
	 * This method also allows us to not violate the law of Demeter in many ugly
	 * ways.
	 * 
	 ...
	 *
	 * You very likely won't want to use this, unless you know exactly what
	 * resource you are requesting.
	 *
	 * @param serviceRelativeUrl
	 *            the part of the URL specific to this service Example:
	 *            query/results
	 * @param name
	 *            application name, information for server which application
	 *            uses this service
